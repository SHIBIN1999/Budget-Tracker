                  ...
                  child: Row(
                    ...
                    children: [
                      Radio(
                        ...
                        groupValue:
                            selectedCategorytype, //category,icon button-2
                        onChanged: (newvalue) {
                          setState(() {
                            //icon button-3
                            // category = value;
                ...
                DropdownButton(
                  ...
                  items: (selectedCategorytype == CategoryType.income
                    ...
                    return DropdownMenuItem(
                      ...
                      child: Text(e.name),
                      onTap: () {
                        print("redtfh$e"); //check the ontap values
                  ...
                  onChanged: (selectedValue) {
                    print("categoryyyyy${selectedValue}");
                    setState(() {
                  ...
                  child: Column(
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: TextFormField(
                          validator: (value) =>
                              value!.isEmpty ? 'enter the note' : null,
                          ...
                          if (_formkey.currentState!.validate()) {
                            if (categoryId == null) {
                              ScaffoldMessenger.of(context)
                                ...
                                content: Text(" Please select add category"),
